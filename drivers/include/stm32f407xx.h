...
typedef struct {
	...
	__IO uint32_t I2SCFGR;			/*!< SPI I2S configuration, Address offset: 0x1C */
	__IO uint32_t I2SPR;			/*!< SPI I2S prescaler regitser, Address offset: 0x20 */	
} SPI_TypeDef;

/* Peripheral definiton for SPI */
